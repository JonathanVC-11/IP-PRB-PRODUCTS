...
@section('content')
  ...
  <h1 class="text-center text-4xl font-bold text-gray-800">Hombre</h1>
<!-- component -->
  ...
  <hr class="my-12 h-0.5 border-t-0 bg-neutral-100 dark:bg-white/10" />
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
            ...
            <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">"Vive la excelencia politécnica con nuestra colección de ropa para hombre: innovación, comodidad y estilo que te acompañan en cada desafío."</p>
