...
@section('content')
<h1 class="text-center text-4xl font-bold text-gray-800">Nuevos Lanzamientos</h1>
...
<section class="bg-white white:bg-gray-900">
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
            ...
            <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">"Expresa tu orgullo politécnico con nuestra colección: ropa diseñada para reflejar la innovación, tradición y excelencia que define al Instituto Politécnico Nacional."</p>
